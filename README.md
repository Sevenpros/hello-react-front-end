...
**[hello-react-front-end]** is a project that allows a user to view random greeting from database.
...
<details>
  ...
  <ul>
    <li><a href="hhttps://rubyonrails.org/">React</a></li>
  </ul>
</details>
...
`gh repo clone Sevenpros/hello-react-front-end`
